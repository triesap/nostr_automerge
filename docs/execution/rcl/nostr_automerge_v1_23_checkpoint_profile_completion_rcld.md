...
- `step_456`: this commit — signed snapshots containing a carrierless or checkpoint-only-authorized change reach the two distinct verified-history refusals.
