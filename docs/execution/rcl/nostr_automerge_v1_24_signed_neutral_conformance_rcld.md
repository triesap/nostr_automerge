...
- `step_465`: this commit — signed sibling forks cover canonical EventId selection, invalid and pending competitors, and late lower valid or invalid evidence.
