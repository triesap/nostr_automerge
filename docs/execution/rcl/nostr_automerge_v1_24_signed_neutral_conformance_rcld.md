...
- `step_479`: this commit — fresh Rust processes reproduce every signed profile report and bind source, lock, toolchain, manifest, and output hashes.
