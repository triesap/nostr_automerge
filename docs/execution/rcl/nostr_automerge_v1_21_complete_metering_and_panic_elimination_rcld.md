...
- `step_428`: this commit — doubled graph, ancestry, actor, equivocation, and deep-path projection models enforce approved counter ratios, paired checkpoint Merkle sizes remain smoke-covered, and quarantine no longer rescans all actors per conflict.
