...
- `step_422`: this commit — public snapshot projection charges canonical bytes and one load operation before Automerge decode and preserves typed resource completion.
