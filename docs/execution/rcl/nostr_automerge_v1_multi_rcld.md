...
- The approved follow-up program contains RCLDs 15 through 28 and steps
  `step_308` through `step_533`. RCLD 20 and `step_407` are the only active
...
6. RCLD 20 — Unknown tags and strict revision classification (`step_399`–`step_409`) — active at `step_407`.
