...
- The approved follow-up program contains RCLDs 15 through 28 and steps
  `step_308` through `step_533`. RCLD 16 and `step_335` are the only active
...
2. RCLD 16 — Stateful control candidate validation (`step_318`–`step_336`) — active at `step_335`.
