...
- The approved follow-up program contains RCLDs 15 through 28 and steps
  `step_308` through `step_533`. RCLD 23 and `step_444` are the only active
...
7. RCLD 21 — Complete metering and panic elimination (`step_410`–`step_429`) — complete.
8. RCLD 22 — Conflict-aware projection v2 (`step_430`–`step_443`) — complete.
9. RCLD 23 — Checkpoint profile completion (`step_444`–`step_459`) — active at `step_444`.
