...
Current RCLD: 19
Current checkpoint: `step_397`
Completed checkpoints: `step_308` through `step_396`
...
| 19 | `step_382`–`step_398` | active | Canonical reports and dispositions |
| 20 | `step_399`–`step_409` | pending | Unknown tags and strict revisions |
