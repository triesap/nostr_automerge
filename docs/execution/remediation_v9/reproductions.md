...
| `FINDING_077` | The enabled shared-allocation regression proves canonical raw change bytes retain one immutable allocation through carrier qualification, evidence indexes, document views, batch changes, memo state, and change lookup. Remaining target-work coverage continues through RCLDs 89–91. | 89, 90, 91 |
