...
RCLD 82 has fourteen committed predecessors through `step_1171`. The opaque
...
| `step_1172` | `V-RUST` | active |
| `step_1173` | `V-REPORT` | next |
...
`step_1172`; 111 later checkpoints remain from `step_1173` through
`step_1283`.
