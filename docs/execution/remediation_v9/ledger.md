...
RCLD 82 has thirteen committed predecessors through `step_1170`. The opaque
...
| `step_1171` | `V-RESOURCE` | active |
| `step_1172` | `V-RUST` | next |
...
`step_1171`; 112 later checkpoints remain from `step_1172` through
`step_1283`.
