...
RCLD 82 has fifteen committed predecessors through `step_1172`. The opaque
...
| `step_1173` | `V-REPORT` | active |
| `step_1174` | `V-RUST` | next |
...
`step_1173`; 110 later checkpoints remain from `step_1174` through
`step_1283`.
