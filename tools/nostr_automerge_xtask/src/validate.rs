...
const PYTHON_VALIDATORS: &[(&str, &str)] = &[
    ...
    (
        "causal_projection_inventory_v19",
        "scripts/validate_causal_projection_inventory_v19.py",
    ),
    (
        "causal_projection_mutation_matrix_v19",
        "scripts/validate_causal_projection_mutation_matrix_v19.py",
    ),
    (
        "causal_projection_proof_events_v19",
        "scripts/validate_causal_projection_proof_events_v19.py",
    ),
    (
        "causal_projection_mutations_v19",
        "scripts/run_causal_projection_mutations_v19.py",
    ),
    (
        "causal_projection_catalogs_v19",
        "scripts/validate_causal_projection_catalogs_v19.py",
    ),
    (
        "causal_projection_final_inventory_v19",
        "scripts/validate_causal_projection_final_inventory_v19.py",
    ),
    (
        "distribution_v19_transition",
        "scripts/validate_distribution_v19_transition.py",
    ),
    (
        "causal_projection_evidence_graph_v19",
        "scripts/validate_causal_projection_evidence_graph_v19.py",
    ),
    (
        "causal_projection_public_qualification_v19",
        "scripts/run_causal_projection_public_qualification_v19.py",
    ),
    (
        "causal_projection_public_assurance_v19",
        "scripts/validate_causal_projection_public_assurance_v19.py",
    ),
    (
        "opaque_causal_projection_v19",
        "scripts/validate_opaque_causal_projection_v19.py",
    ),
    (
        "causal_projection_combined_assurance_v19",
        "scripts/validate_causal_projection_combined_assurance_v19.py",
    ),
    (
        "causal_projection_finding_closure_v19",
    ...
    (
        "causal_projection_attestation_execution_base_v19",
        "scripts/validate_causal_projection_attestation_execution_base_v19.py",
    ),
    (
        "causal_projection_clean_attestation_v19",
        "scripts/run_causal_projection_clean_attestation_v19.py",
    ),
    (
    ...
    (
        "causal_projection_reproductions_v19",
    ...
    (
        "v19_sequence_reconciliation",
        "scripts/validate_v19_sequence_reconciliation.py",
    ),
    (
...
mod tests {
    ...
    fn add_repository_xtask_validation() {
        ...
        assert!(names.contains(&"causal_projection_inventory_v19"));
        assert!(names.contains(&"causal_projection_mutation_matrix_v19"));
        assert!(names.contains(&"causal_projection_proof_events_v19"));
        assert!(names.contains(&"causal_projection_mutations_v19"));
        assert!(names.contains(&"causal_projection_catalogs_v19"));
        assert!(names.contains(&"causal_projection_final_inventory_v19"));
        assert!(names.contains(&"distribution_v19_transition"));
        ...
        assert!(names.contains(&"causal_projection_attestation_execution_base_v19"));
        assert!(names.contains(&"causal_projection_clean_attestation_v19"));
        ...
        assert!(names.contains(&"v19_sequence_reconciliation"));
        ...
        assert!(names.contains(&"causal_projection_proofs_v18"));
        assert!(names.contains(&"causal_projection_properties_v18"));
        assert!(names.contains(&"causal_projection_mutations_v18"));
        assert!(names.contains(&"causal_projection_catalogs_v18"));
        ...
        assert!(names.contains(&"opaque_causal_projection_v18"));
        assert!(names.contains(&"causal_projection_combined_assurance_v18"));
        assert!(names.contains(&"causal_projection_finding_closure_v18"));
        assert!(names.contains(&"causal_projection_completion_v18"));
        assert!(names.contains(&"causal_projection_final_decision_v18"));
        assert!(names.contains(&"causal_projection_clean_candidate_v18"));
