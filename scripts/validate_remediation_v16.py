...
def validate(authority: Any, findings: Any, ledger: Any, schema: Any) -> None:
    ...
    require(
        ...
        == {
            "active_rcld": 126,
            "active_step": "step_1475",
            "next_step": "step_1476",
            "last_planned_step": "step_1482",
            "remaining_checkpoint_count": 7,
    ...
    require(
        l["active_checkpoint_scope"] == STEP_1475_SCOPE
        and STEP_1475_SCOPE == sorted(STEP_1475_SCOPE)
        and all((ROOT / path).exists() for path in STEP_1475_SCOPE),
        "ledger:scope",
    )
    require(
        l["predecessors"]
...
def self_test(authority: Any, findings: Any, ledger: Any, schema: Any) -> int:
    mutations = [
        ...
        ("cursor", "ledger", lambda value: value["cursor"].update(next_step="step_1477")),
...
def main() -> int:
    ...
    print(
        "PASS: remediation-v16 active=step_1475 next=step_1476 "
