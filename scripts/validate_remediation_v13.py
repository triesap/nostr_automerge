...
SCOPE = ["docs/execution/remediation_v13/ledger.md","fixtures/distribution/manifest_v14.json","implementation/runtime_ledger_v13.json","reports/spec_baseline.txt","scripts/generate_distribution_v14.py","scripts/validate_distribution_v14.py","scripts/validate_private_reproduction_boundary_v9.py","scripts/validate_remediation_v13.py","scripts/validate_spec.py","spec/distribution_v14_transition.json","tools/nostr_automerge_xtask/src/validate.rs","tools/validation/distribution_v14.schema.json"]
...
def validate(authority: object, findings: object, ledger: object, schema: object, evidence: object, evidence_schema: object) -> None:
    ...
    require(l["cursor"] == {"active_rcld":118,"active_step":"step_1436","next_step":"step_1437","last_planned_step":"step_1452","remaining_checkpoint_count":17,"remaining_rcld_count":3}, "ledger:cursor")
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1436 findings=9 mutations={mutations}")
    return 0
