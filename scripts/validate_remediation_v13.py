...
OPEN = ["FINDING_111"]
SCOPE = ["docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/causal_projection_mutation_qualification_v14.json","reports/spec_baseline.txt","scripts/validate_causal_projection_mutation_qualification_v14.py","scripts/validate_private_reproduction_boundary_v9.py","scripts/validate_remediation_v13.py","scripts/validate_spec.py","tools/nostr_automerge_xtask/src/validate.rs","tools/validation/causal_projection_mutation_qualification_v14.schema.json"]
...
def validate(authority: object, findings: object, ledger: object, schema: object, evidence: object, evidence_schema: object) -> None:
    ...
    require(l["cursor"] == {"active_rcld":120,"active_step":"step_1448","next_step":"step_1449","last_planned_step":"step_1452","remaining_checkpoint_count":5,"remaining_rcld_count":1}, "ledger:cursor")
    ...
    require(latest_predecessor == {"step":"step_1447","candidate":"8b6c4278b44fb2f9a95d1d2c8eefbf42fee2e327","owner_class":"public","result":"pass"}, "ledger:latest_predecessor")
    ...
    l["predecessors"].append(latest_predecessor)
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1448 open=1 closed=8 mutations={mutations}")
    return 0
