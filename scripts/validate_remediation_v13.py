...
OPEN = ["FINDING_111"]
SCOPE = ["docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/causal_projection_assurance_v13.json","reports/spec_baseline.txt","scripts/validate_causal_projection_assurance_v13.py","scripts/validate_private_reproduction_boundary_v9.py","scripts/validate_remediation_v13.py","scripts/validate_spec.py","spec/remediation_findings_v13.json","tools/nostr_automerge_xtask/src/validate.rs","tools/validation/causal_projection_assurance_v13.schema.json"]
...
def validate(authority: object, findings: object, ledger: object, schema: object, evidence: object, evidence_schema: object) -> None:
    ...
    require(l["cursor"] == {"active_rcld":118,"active_step":"step_1438","next_step":"step_1439","last_planned_step":"step_1452","remaining_checkpoint_count":15,"remaining_rcld_count":3}, "ledger:cursor")
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1438 open=1 closed=8 mutations={mutations}")
    return 0
