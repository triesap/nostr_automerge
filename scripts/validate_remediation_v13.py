...
SCOPE = ["docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/causal_projection_implementation_gate_v13.json","reports/spec_baseline.txt","scripts/validate_causal_projection_implementation_gate_v13.py","scripts/validate_private_reproduction_boundary_v9.py","scripts/validate_remediation_v13.py","scripts/validate_spec.py","tools/nostr_automerge_xtask/src/validate.rs","tools/validation/causal_projection_implementation_gate_v13.schema.json"]
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1432 findings=9 mutations={mutations}")
    return 0
