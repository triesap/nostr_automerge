...
SCOPE = ["crates/nostr_automerge/tests/remediation_v13_reproductions.rs","docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/spec_baseline.txt","scripts/reproduce_remediation_v13.py","scripts/validate_remediation_v13.py","spec/remediation_v13_reproductions.json"]
...
def validate(authority: object, findings: object, ledger: object, schema: object, evidence: object, evidence_schema: object) -> None:
    ...
    require(l["cursor"] == {"active_rcld":116,"active_step":"step_1423","next_step":"step_1424","last_planned_step":"step_1452","remaining_checkpoint_count":30,"remaining_rcld_count":5}, "ledger:cursor")
    require(l["findings"] == {"open":OPEN,"held":["FINDING_080"]}, "ledger:findings")
    require(l["active_checkpoint_scope"] == SCOPE, "ledger:scope")
    require(l["predecessors"] == [{"step":"step_1419","candidate":"00ef954ff2dece37119ad235638046ffaa7305d4","owner_class":"public","result":"pass"},{"step":"step_1420","candidate":"6bbc29b5fa1a0e88cf5f61d9b751181f913c928b","owner_class":"public","result":"pass"},{"step":"step_1421","candidate":"38c65ae597af0500af64b67c21fb12f7933125b0","owner_class":"public","result":"pass"},{"step":"step_1422","candidate":"2435f60145aba99cc5f96a49aadc86e162a82b06","owner_class":"public","result":"pass"}], "ledger:predecessor")
...
def self_test(authority: dict, findings: dict, ledger: dict, schema: dict, evidence: dict, evidence_schema: dict) -> int:
    ...
    for label, target, mutate in [
        ...
        ("cursor","ledger",lambda value: value["cursor"].update(active_step="step_1422")),
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1423 findings=9 mutations={mutations}")
    return 0
