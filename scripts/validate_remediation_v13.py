...
SCOPE = ["crates/nostr_automerge/src/graph/actor_state.rs","docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/spec_baseline.txt","scripts/validate_causal_projection_operations_v13.py","scripts/validate_remediation_v13.py","spec/causal_projection_operation_contract_v13.json","tools/validation/causal_projection_operation_contract_v13.schema.json"]
...
def self_test(authority: dict, findings: dict, ledger: dict, schema: dict, evidence: dict, evidence_schema: dict) -> int:
    ...
    for label, target, mutate in [
        ...
        ("cursor","ledger",lambda value: value["cursor"].update(active_step="step_1425")),
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1426 findings=9 mutations={mutations}")
    return 0
