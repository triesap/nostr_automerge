...
SCOPE = ["crates/nostr_automerge/tests/remediation_v13_reproductions.rs","docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/causal_projection_authority_gate_v13.json","reports/spec_baseline.txt","scripts/validate_causal_projection_authority_gate_v13.py","scripts/validate_causal_projection_operations_v13.py","scripts/validate_remediation_v13.py","scripts/validate_spec.py","spec/causal_projection_operation_contract_v13.json","tools/nostr_automerge_xtask/src/validate.rs","tools/validation/causal_projection_authority_gate_v13.schema.json","tools/validation/causal_projection_operation_contract_v13.schema.json"]
...
def validate(authority: object, findings: object, ledger: object, schema: object, evidence: object, evidence_schema: object) -> None:
    ...
    require(l["cursor"] == {"active_rcld":116,"active_step":"step_1425","next_step":"step_1426","last_planned_step":"step_1452","remaining_checkpoint_count":28,"remaining_rcld_count":5}, "ledger:cursor")
...
def self_test(authority: dict, findings: dict, ledger: dict, schema: dict, evidence: dict, evidence_schema: dict) -> int:
    ...
    for label, target, mutate in [
        ...
        ("cursor","ledger",lambda value: value["cursor"].update(active_step="step_1424")),
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1425 findings=9 mutations={mutations}")
    return 0
