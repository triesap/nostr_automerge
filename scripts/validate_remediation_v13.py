...
SCOPE = [
    ...
    *[
        f"fixtures/v14/rebindings/causal_projection/{identifier}.{suffix}.json"
        for identifier in (
            "canonical_derivation_exact_budget", "deep_actor_predecessor_exact_budget",
            "deep_delta_absent_lookup_exact_budget", "deep_delta_extend_exact_budget",
            "deep_delta_root_lookup_exact_budget", "empty_merge_frontier_exact_budget",
            "epoch_writer_authorization_exact_budget", "many_actor_causal_next_op_exact_budget",
            "wide_epoch_ancestry_exact_budget",
        )
        for suffix in ("expected", "fixture", "input")
    ],
    "implementation/runtime_ledger_v13.json", "reports/rust_conformance_v14.json",
    "reports/spec_baseline.txt", "scripts/generate_distribution_v14.py",
    "scripts/validate_distribution_v14.py", "scripts/validate_private_reproduction_boundary_v9.py",
    "scripts/validate_remediation_v13.py", "scripts/validate_rust_conformance_v14.py",
    "scripts/validate_spec.py", "spec/distribution_v14_transition.json",
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1437 findings=9 mutations={mutations}")
    return 0
