...
def validate(authority: object, findings: object, ledger: object, schema: object, evidence: object, evidence_schema: object) -> None:
    ...
    require(l["cursor"] == {"active_rcld":118,"active_step":"step_1434","next_step":"step_1435","last_planned_step":"step_1452","remaining_checkpoint_count":19,"remaining_rcld_count":3}, "ledger:cursor")
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1434 findings=9 mutations={mutations}")
    return 0
