...
OPEN = ["FINDING_111"]
SCOPE = ["docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/causal_projection_operation_inventory_v14.json","reports/causal_projection_proof_catalog_v14.json","reports/spec_baseline.txt","scripts/validate_causal_projection_evidence_v14.py","scripts/validate_private_reproduction_boundary_v9.py","scripts/validate_remediation_v13.py","scripts/validate_spec.py","tools/nostr_automerge_xtask/src/validate.rs","tools/validation/causal_projection_operation_inventory_v14.schema.json","tools/validation/causal_projection_proof_catalog_v14.schema.json"]
...
def validate(authority: object, findings: object, ledger: object, schema: object, evidence: object, evidence_schema: object) -> None:
    ...
    require(l["cursor"] == {"active_rcld":120,"active_step":"step_1447","next_step":"step_1448","last_planned_step":"step_1452","remaining_checkpoint_count":6,"remaining_rcld_count":1}, "ledger:cursor")
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1447 open=1 closed=8 mutations={mutations}")
    return 0
