...
OPEN = ["FINDING_111"]
SCOPE = ["docs/execution/remediation_v13/ledger.md","implementation/runtime_ledger_v13.json","reports/opaque_causal_projection_v14.json","reports/spec_baseline.txt","scripts/validate_opaque_causal_projection_v14.py","scripts/validate_private_reproduction_boundary_v9.py","scripts/validate_remediation_v13.py","scripts/validate_spec.py","tools/nostr_automerge_xtask/src/validate.rs","tools/validation/opaque_causal_projection_v14.schema.json"]
...
def main() -> int:
    ...
    print(f"PASS: remediation-v13 authority active=step_1446 open=1 closed=8 mutations={mutations}")
    return 0
