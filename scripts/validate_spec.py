...
VALIDATORS = [
    ...
    "validate_causal_projection_final_decision_v14.py",
    "validate_remediation_v15.py",
    "validate_remediation_v16.py",
    "reproduce_remediation_v16.py",
    "validate_causal_projection_counter_oracle_reproductions_v16.py",
    ...
    "validate_causal_projection_proof_catalog_v15.py",
    "validate_causal_projection_source_ownership_v15.py",
    "run_causal_projection_behavior_mutations_v15.py",
    ...
    "validate_causal_projection_final_decision_v15.py",
]
