...
VALIDATORS = [
    ...
    "run_causal_projection_mutations_v16.py",
    ...
    "run_causal_projection_mutations_v18.py",
    "validate_causal_projection_catalogs_v18.py",
    "validate_causal_projection_final_inventory_v18.py",
    "validate_causal_projection_evidence_graph_v18.py",
    "validate_distribution_v18_transition.py",
    "run_causal_projection_public_qualification_v18.py",
    "validate_opaque_causal_projection_v18.py",
    "validate_causal_projection_combined_assurance_v18.py",
    "validate_causal_projection_finding_closure_v18.py",
    "validate_causal_projection_completion_v18.py",
    "validate_causal_projection_final_decision_v18.py",
    "validate_causal_projection_clean_candidate_v18.py",
    "validate_remediation_v19.py",
    "validate_causal_projection_contracts_v19.py",
    "validate_causal_projection_inventory_v19.py",
    "validate_causal_projection_mutation_matrix_v19.py",
    "validate_causal_projection_proof_events_v19.py",
    "run_causal_projection_mutations_v19.py",
    "validate_causal_projection_catalogs_v19.py",
    "validate_causal_projection_final_inventory_v19.py",
    "validate_causal_projection_evidence_graph_v19.py",
    "validate_distribution_v19_transition.py",
    "run_causal_projection_public_qualification_v19.py",
    "validate_causal_projection_public_assurance_v19.py",
    "validate_opaque_causal_projection_v19.py",
    "validate_causal_projection_combined_assurance_v19.py",
    "validate_causal_projection_finding_closure_v19.py",
    "validate_causal_projection_completion_v19.py",
    "validate_causal_projection_final_decision_v19.py",
    "validate_causal_projection_attestation_execution_base_v19.py",
    "run_causal_projection_clean_attestation_v19.py",
    "validate_causal_projection_release_boundary_v19.py",
    "validate_causal_projection_reproductions_v19.py",
    "validate_causal_projection_v18_execution_mapping_v19.py",
    "validate_v19_sequence_reconciliation.py",
    ...
    "validate_distribution_v16.py",
    "validate_rust_conformance_v16.py",
...
V19_HISTORICAL_VALIDATORS = {
    ...
    if "causal_projection" in validator and "_v19" not in validator
}
...
def active_validators(stage: str) -> list[str]:
    ...
    v19_active = (ROOT / "spec/remediation_v19_authority.json").is_file()
    if (ROOT / "spec/resource_followup_authority_v10.json").is_file():
        return [
            ...
            and (not v19_active or validator not in V19_HISTORICAL_VALIDATORS)
        ]
...
def controlled_files() -> list[pathlib.Path]:
    roots = ("AGENTS.md", "README.md", "CONTRIBUTING.md", "SECURITY.md", "CODEOWNERS", "spec", "fixtures/README.md", "fixtures/examples", "fixtures/schema", "fixtures/v15", "docs/provenance", "reports/evidence/v17/proofs", "reports/evidence/v17/mutations")
    files = []
    for name in roots:
        path = ROOT / name
    ...
    files.extend(
        ...
        for name in (
            ...
            "reports/causal_projection_catalogs_v19.json",
            "reports/causal_projection_final_inventory_v19.json",
            "reports/causal_projection_evidence_graph_v19.json",
            "reports/causal_projection_public_qualification_v19.json",
            "reports/causal_projection_public_assurance_v19.json",
            "reports/opaque_causal_projection_v19.json",
            "reports/causal_projection_combined_assurance_v19.json",
            "reports/causal_projection_finding_closure_v19.json",
            "reports/causal_projection_completion_v19.json",
            "reports/causal_projection_final_decision_v19.json",
            "reports/causal_projection_attestation_execution_base_v19.json",
            "reports/causal_projection_clean_candidate_v19.json",
            ...
            "tools/validation/causal_projection_catalogs_v19.schema.json",
            "tools/validation/causal_projection_final_inventory_v19.schema.json",
            "tools/validation/causal_projection_evidence_graph_v19.schema.json",
            "tools/validation/distribution_v19_transition.schema.json",
            "tools/validation/causal_projection_public_qualification_v19.schema.json",
            "tools/validation/causal_projection_public_assurance_v19.schema.json",
            "tools/validation/opaque_causal_projection_v19.schema.json",
            "tools/validation/causal_projection_combined_assurance_v19.schema.json",
            "tools/validation/causal_projection_finding_closure_v19.schema.json",
            "tools/validation/causal_projection_completion_v19.schema.json",
            "tools/validation/causal_projection_final_decision_v19.schema.json",
            "tools/validation/causal_projection_attestation_execution_base_v19.schema.json",
            "tools/validation/causal_projection_clean_candidate_v19.schema.json",
            ...
            "tools/validation/runtime_ledger_v19.schema.json",
            "tools/validation/causal_projection_contracts_v19.schema.json",
            "tools/validation/causal_projection_inventory_v19.schema.json",
            "tools/validation/causal_projection_mutation_matrix_v19.schema.json",
            "tools/validation/causal_projection_mutations_v19.schema.json",
            "tools/validation/causal_projection_proofs_v19.schema.json",
            "tools/validation/causal_projection_release_boundary_v19.schema.json",
            "tools/validation/causal_projection_reproductions_v19.schema.json",
            "tools/validation/causal_projection_v18_execution_mapping_v19.schema.json",
            "tools/validation/v19_sequence_reconciliation.schema.json",
