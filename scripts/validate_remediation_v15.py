...
STEP_SCOPES = {
    ...
    "step_1465": [
        ...
        "fixtures/v15/rebindings/causal_projection/canonical_derivation_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/canonical_derivation_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/canonical_derivation_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/deep_actor_predecessor_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/deep_actor_predecessor_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/deep_actor_predecessor_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_absent_lookup_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_absent_lookup_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_absent_lookup_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_extend_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_extend_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_extend_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_root_lookup_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_root_lookup_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/deep_delta_root_lookup_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/empty_merge_frontier_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/empty_merge_frontier_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/empty_merge_frontier_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/epoch_writer_authorization_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/epoch_writer_authorization_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/epoch_writer_authorization_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/many_actor_causal_next_op_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/many_actor_causal_next_op_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/many_actor_causal_next_op_exact_budget.input.json",
        "fixtures/v15/rebindings/causal_projection/wide_epoch_ancestry_exact_budget.expected.json",
        "fixtures/v15/rebindings/causal_projection/wide_epoch_ancestry_exact_budget.fixture.json",
        "fixtures/v15/rebindings/causal_projection/wide_epoch_ancestry_exact_budget.input.json",
        "implementation/runtime_ledger_v15.json",
