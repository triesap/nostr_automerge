...
def validate_ledger(ledger: object) -> None:
    ...
    require_equal(cursor, {"active_rcld": 114, "active_step": "step_1411", "next_step": "step_1412", "last_planned_step": "step_1419", "remaining_checkpoint_count": 8, "remaining_rcld_count": 1}, "ledger:cursor")
    ...
    if not isinstance(predecessors, list) or len(predecessors) != 45:
...
def main() -> None:
    ...
    print("- active=RCLD114/step_1411")
