...
def main() -> int:
    ...
    for requirement in requirements:
        ...
        if classification == "rust-and-typescript":
            ...
            overlay = {
                ...
                "implementation_commit": attestation["commit"], "attestation_path": "reports/interop_typescript_v3.json",
    ...
    overlay_report = {
        "schema": "nostr_automerge.requirement_typescript_overlay.v4", "attestation_path": "reports/interop_typescript_v3.json",
    ...
    report = {
        "schema": "nostr_automerge.requirement_coverage.v4", "requirements_sha256": sha256(requirements_path),
    ...
    canonical_write(ROOT / "reports/requirements_coverage_v4.json", report)
