#!/usr/bin/env python3
"""Collapse matching signed-v5 profiles into source-free v4 attestations."""
...
def main() -> int:
    ...
    rust_attestation = {
        "schema": "nostr_automerge.rust_interop_attestation.v4",
    ...
    typescript_attestation = {
        "schema": "nostr_automerge.interop_attestation.v4",
    ...
    combined = {
        "schema": "nostr_automerge.interop_combined.v4",
        "fixture_distribution_sha256": manifest_hash,
    ...
    (output_root / "interop_rust_v4.json").write_bytes(rust_bytes)
    (output_root / "interop_typescript_v4.json").write_bytes(typescript_bytes)
    (output_root / "interop_combined_v4.json").write_bytes(canonical(combined))
    print("PASS: final Rust and TypeScript signed-v5 profiles match byte-for-byte")
    return 0
