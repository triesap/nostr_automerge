...
FAMILY_FIELDS = ["id","counter","target_scaled"]
...
def validate(contract: object, schema: object, source: str) -> None:
    ...
    require(contract["schema"] == "nostr_automerge.causal_projection_operation_contract.v13.v1" and contract["status"] in {"approved_discovery_complete","implementation_complete"} and contract["result"] == "pass", "contract:state")
    ...
    require(contract["final_operation_count"] is None or type(contract["final_operation_count"]) is int, "count")
