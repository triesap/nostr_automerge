...
MUTATIONS = (
    ...
    Mutation("report", "crates/nostr_automerge/src/reference/evaluate.rs", "control_dispositions: progress.control_dispositions,", "control_dispositions: BTreeMap::new(),", "reference::evaluate::tests::implement_full_batch_reference_evaluator"),
    Mutation("report", "crates/nostr_automerge/src/reference/evaluate.rs", "accepted_at_control: progress.accepted_at_control,", "accepted_at_control: BTreeMap::new(),", "reference::evaluate::tests::implement_full_batch_reference_evaluator"),
    Mutation("report", "crates/nostr_automerge/src/reference/evaluate.rs", "integrity_alerts: progress.integrity_alerts,", "integrity_alerts: Vec::new(),", "reference::evaluate::tests::implement_full_batch_reference_evaluator"),
    Mutation("event_disposition", "crates/nostr_automerge/src/engine/reference_evaluator.rs", "records.insert(hints.event_id(), (ProtocolDisposition::Accepted, None));", "records.insert(hints.event_id(), (ProtocolDisposition::Excluded, None));", "selected_manifest_control_references_are_resolved_after_replacement", "public_engine_api"),
    Mutation("event_disposition", "crates/nostr_automerge/src/engine/reference_evaluator.rs", "CheckpointVerificationStatus::Verified => ProtocolDisposition::Accepted,", "CheckpointVerificationStatus::Verified => ProtocolDisposition::Excluded,", "signed_single_chunk_checkpoint_verifies_real_automerge_history", "public_engine_api"),
    Mutation("event_disposition", "crates/nostr_automerge/src/engine/reference_evaluator.rs", "| CheckpointVerificationStatus::Cancelled => ProtocolDisposition::Pending,", "| CheckpointVerificationStatus::Cancelled => ProtocolDisposition::Accepted,", "validated_checkpoint_descriptor_carrier_enters_corpus", "public_engine_api"),
