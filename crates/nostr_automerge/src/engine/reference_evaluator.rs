...
mod tests {
    ...
    fn v12_post_branch_fixture_stops_at_exact_internal_boundary() {
        ...
        // active remediation exposes three hundred thirty-five previously hidden
        // projection, actor-sequence, ancestry, authorization, and dependency-
        // closure operations before
        // the same post-branch boundary;
        // distribution v14 will bind the replacement exact budget after the
        // work closure.
        assert_eq!(fixture_items.checked_add(335), Some(branch_stop_items));
