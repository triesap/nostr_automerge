...
mod tests {
    ...
    fn v12_post_branch_fixture_stops_at_exact_internal_boundary() {
        ...
        // v12 remediation exposes fifty previously hidden projection source
        // reads and publications before the same post-branch boundary;
        // distribution v13 will bind the replacement exact budget after the
        // work closure.
        assert_eq!(fixture_items.checked_add(50), Some(branch_stop_items));
